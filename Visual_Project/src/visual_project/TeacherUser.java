...
public class TeacherUser {
    public TeacherUser(JFrame teacherFrame) {
        ...
        JButton absenteeismbtn = new JButton("Absenteeism");
        absenteeismbtn.setBounds(15, 100, 120, 60);
        btnpanel.add(absenteeismbtn);
        absenteeismbtn.addActionListener(e -> {
            ...
            DefaultTableModel model = new DefaultTableModel(new String[]{"Number", "Name", "Surname","Lecture", "Absenteeism"}, 0);
            ...
            JLabel absenteeismlbl = new JLabel("Attendance Status:");
            absenteeismlbl.setBounds(180, 520, 150, 30);
            teacherFrame.add(absenteeismlbl);
        ...
        removeBtn.addActionListener(e -> {
            teacherFrame.getContentPane().removeAll();
            new LogIn(teacherFrame); // Geri dönme işlevi
            teacherFrame.revalidate();                 // Düzeni yeniden hesapla
            teacherFrame.repaint();   
        });
        teacherFrame.add(btnpanel);
